...
* [rclone](https://rclone.org/) + (optionally) [celeste](https://github.com/hwittenborn/celeste) | [syncthing](https://syncthing.net/) | [Zaloha2.sh](https://github.com/Fitus/Zaloha2.sh)
