...
- [] [cmp-tabnine](https://github.com/tzachar/cmp-tabnine)
- [] [copilot.lua](https://github.com/zbirenbaum/copilot.lua) AI
...
- [] [copilot.lua](https://github.com/zbirenbaum/copilot.lua) - 773, suggest, lua rewrite of copilot.vim, still hopping between the
.vim and .lua to figure out if this one is just suggesting less but so
far I like it a bit better.
...
- [] [smart-tab.nvim](https://img.shields.io/github/stars/boltlessengineer/smart-tab.nvim)
- [] [smart-tab.nvim](https://img.shields.io/github/last-commit/boltlessengineer/smart-tab.nvim)
- [] [smart-tab.nvim](https://img.shields.io/github/commit-activity/y/boltlessengineer/smart-tab.nvim)
- - [] [smarttab.nvim](https://github.com/nvim-jo/smarttab.nvim)
- [] [smarttab.nvim](https://img.shields.io/github/stars/nvim-jo/smarttab.nvim)
- [] [smarttab.nvim](https://img.shields.io/github/last-commit/nvim-jo/smarttab.nvim)
- [] [smarttab.nvim](https://img.shields.io/github/commit-activity/y/nvim-jo/smarttab.nvim)
...
- [] [z.lua](https://img.shields.io/github/stars/skywind3000/z.lua)
- [] [z.lua](https://img.shields.io/github/last-commit/skywind3000/z.lua)
- [] [z.lua](https://img.shields.io/github/commit-activity/y/skywind3000/z.lua)
- - [] [z.nvim](https://github.com/tenfyzhong/z.nvim)
- [] [z.nvim](https://img.shields.io/github/stars/tenfyzhong/z.nvim)
- [] [z.nvim](https://img.shields.io/github/last-commit/tenfyzhong/z.nvim)
- [] [z.nvim](https://img.shields.io/github/commit-activity/y/tenfyzhong/z.nvim)
...
- [] [remember.nvim](https://img.shields.io/github/stars/vladdoster/remember.nvim)
- [] [remember.nvim](https://img.shields.io/github/last-commit/vladdoster/remember.nvim)
- [] [remember.nvim](https://img.shields.io/github/commit-activity/y/vladdoster/remember.nvim)
- - [] [NeoView.nvim](https://github.com/ecthelionvi/NeoView.nvim)
- [] [NeoView.nvim](https://img.shields.io/github/stars/ecthelionvi/NeoView.nvim)
- [] [NeoView.nvim](https://img.shields.io/github/last-commit/ecthelionvi/NeoView.nvim)
- [] [NeoView.nvim](https://img.shields.io/github/commit-activity/y/ecthelionvi/NeoView.nvim)
- - [] [nvim-hooklinesinker](https://github.com/Enrique-ZA/nvim-hooklinesinker)
- [] [nvim-hooklinesinker](https://img.shields.io/github/stars/Enrique-ZA/nvim-hooklinesinker)
- [] [nvim-hooklinesinker](https://img.shields.io/github/last-commit/Enrique-ZA/nvim-hooklinesinker)
- [] [nvim-hooklinesinker](https://img.shields.io/github/commit-activity/y/Enrique-ZA/nvim-hooklinesinker)
