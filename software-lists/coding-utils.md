...
* https://github.com/XAMPPRocky/tokei - code summarizer
    
    → compare https://github.com/AlDanial/cloc - Count Lines of Code  compare with tokei
...
* https://github.com/cyrus-and/gdb-dashboard - Modular visual interface for GDB.
* https://github.com/rr-debugger/rr - Debug the recording, deterministically, as many times as you want. https://rr-project.org/
* https://github.com/shobrook/rebound - Command-line debugger that instantly fetches Stack Overflow results when you get a compiler error.  - fork and update?
...
* https://github.com/lemoony/snipkit- looks really look, interesting concept  (Go)
* https://github.com/qownnotes/qc looks great, need to try
* https://github.com/knqyf263/pet-  need to compare with the-way
* https://github.com/raylee/tldr-sh-client - A fully-functional bash client for tldr, simplified and community-driven man pages → move to qol
* https://github.com/srijanshetty/snips - Command line tool to manage snippets of code. Node
...
* https://github.com/docsifyjs/docsify/ - [Docsify](https://docsify.js.org/)
* https://github.com/zestdocs/zest - unmaintained, but fork and update?
...
* https://github.com/alecthomas/chroma (Go)
* https://highlightjs.org/ (JavaScript)
* https://github.com/trishume/syntect (Rust)

## Logs
* https://github.com/folkertvanheusden/multitail - A command to open multiple log files in a single terminal window and monitor them in real-time.
* https://github.com/dogoncouch/logdissect/ - CLI utility and Python API for analyzing log files and other data. ([MIT](https://github.com/dogoncouch/logdissect/blob/master/LICENSE)) - fork, update, and extend!
* https://github.com/tstack/lnav - [The Logfile Navigator](https://github.com/tstack/lnav) - An advanced and colorful log file viewer with TUI interface.
...
* https://github.com/mermaid-js/mermaid http://mermaid.js.org/
...
* https://github.com/kubeflow/katib (hyperparameter tuning)
* https://github.com/IllDepence/unarXive
* https://github.com/arogozhnikov/einops https://arogozhnikov.github.io/2023/07/13/retrospective-thoughts-on-einops.html
...
* https://github.com/hbons/SparkleShare - An Open Source collaboration and sharing tool https://www.sparkleshare.org/ [Nix](https://search.nixos.org/packages?channel=23.05&from=0&size=50&sort=relevance&type=packages&query=sparkleshare)
...
* https://github.com/nanoc/nanoc - Static site generator written in Ruby; extremely powerful and customizable; support many formats to generate HTML content.
* https://github.com/sintaxi/surge - Static web publishing on surge.sh CDN.
* https://github.com/metalsmith/metalsmith - An extremely simple static site generator; all functionalities are provided by plugins that can be combined and chained; written and extendable in Javascript.
...
* https://github.com/httpie/httpie - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* https://github.com/eliangcs/http-prompt - Interactive HTTP client featuring autocomplete and syntax highlighting.
* https://github.com/jonaslu/ain - HTTP client with a simple format to organize API endpoints.
### HTTP Server
* https://github.com/vercel/serve - Serve static files (https, CORS, GZIP compression, etc).
* https://github.com/snwfdhmp/simplehttp - Easily serve a local directory over HTTP. - try with planager
*  https://github.com/msoap/shell2http - Shell script based HTTP server. - try with planager
* https://github.com/gchaincl/httplab - The interactive web server, let you inspect HTTP requests and forge responses.
* https://github.com/comradequinn/hflow - A command-line, debugging http/s proxy server.
* https://github.com/jneen/balls - Bash on Balls
### Socket
* https://github.com/PabloLec/neoss - User-friendly and detailed socket statistics.
* https://github.com/pvarentsov/iola - Socket client with REST API.
### Server, Deployment
* https://github.com/ogham/dog [- DNS lookup client *(better `dig`)](https://dev.to/lissy93/cli-tools-you-cant-live-without-57f6#doghttpsgithubcomoghamdog-dns-lookup-client-_better-dig_)* https://github.com/vschwaberow/dog - looks good
* https://github.com/schollz/cowyo - Feature rich wiki webserver for minimalists. - planager?
* https://github.com/openresty/lua-nginx-module
* [xh](https://github.com/ducaale/xh) - Friendly and fast tool for sending HTTP requests - like Httpie, but faster
* https://github.com/coreybutler/fenix [Fenix Web Server](https://fenixwebserver.com/) - A multi-host local static web server with push-button sharing (desktop app).
* https://github.com/chris-rock/vesper - Vesper is a HTTP framework for Bash/Unix Shell
* https://github.com/snwfdhmp/simplehttp Fastest and simplest way to start serving a local directory over http.
* https://github.com/zeit/serve - Serves a static site, single page application, or just a static file, and provides a neat interface for listing the directory's contents.
* https://github.com/sapegin/shipit - Minimalistic SSH deployment
### Frameworks
* https://hypermedia.systems/
* https://cordova.apache.org/
* https://github.com/Avaiga/taipy - Turns Data and AI algorithms into full web applications in no time.
* https://trunkrs.dev/
...
* https://github.com/TYPO3/typo3 - [The TYPO3 Project and Community – Open Source CMS](https://typo3.org/)
### Testing / Mocking
* https://github.com/processone/tsung - A multi-protocol distributed load testing tool that can be used to stress HTTP, WebDAV, SOAP, PostgreSQL, MySQL, LDAP and Jabber/XMPP servers.
* https://github.com/alexfernandez/loadtest - Run load tests.
...
* https://github.com/macbre/phantomas - website perf evaluation tool
...
* https://github.com/jiahaog/nativefier - Make any web page a desktop application.
    * https://sass-lang.com/
* https://github.com/sgentle/caniuse-cmd - Search [caniuse.com](https://github.com/Correia-jpv/fucking-awesome-cli-apps/blob/main/caniuse.com) about browser support of features.
* https://github.com/charmparticle/xpe - A commandline xpath tool that is easy to use.
* https://github.com/hannob/snallygaster - Tool to scan for secret files on HTTP servers.
* https://github.com/sindresorhus/strip-css-comments-cli - Strip comments from CSS.
* https://github.com/fractarchy/fractarchy-cms
* https://github.com/utkusen/urlhunter - Recon tool that allows searching on URLs that are exposed via shortener services.
* https://todomvc.com/
...
* https://github.com/localtunnel/localtunnel - Expose your localhost to the world for easy testing and sharing.
* https://github.com/cristianoliveira/ergo  - The management of multiple local services running over different ports made easy.
...
* https://vitepress.dev/ (from  https://wiki.nikiv.dev/, https://wiki.nikiv.dev/free https://github.com/nikitavoloboev/knowledge )
