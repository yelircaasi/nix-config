...
* [→ [commitlint.js.org/#/reference-rules](https://commitlint.js.org/#/reference-rules)*](https://commitlint.js.org/#/reference-rules](https://commitlint.js.org/#/reference-rules)*)   - [freecodecamp.org/news/how-to-use-commitlint-to-write-good-commit-messages/)*](https://www.freecodecamp.org/news/how-to-use-commitlint-to-write-good-commit-messages/)*)   - [conventionalcommits.org/en/v1.0.0/)](https://www.conventionalcommits.org/en/v1.0.0/))
...
* ( ) [](https://git.causal.agency/cgit-pink/about/)*   -  [git.zx2c4.com/cgit/](https://git.zx2c4.com/cgit/) - A hyperfast web frontend for git repositories written in C.
