-- sample
vim.keymap.set('n', '<leader>alf', function() print("A lua func") end, {noremap = true})

-- debugging
vim.keymap.set('n', '<leader>db', "<cmd> DapToggleBreakpoint <CR>", {noremap = true})
vim.keymap.set('n', '<leader>dpr', function() require("dap-python").test_method() end, {noremap = true})
