...
config.colors = {
	...
	ansi = {
		"$C_terminalColor00$", -- 'black',
		"$C_terminalColor01$", --  'maroon',
		"$C_terminalColor02$", -- 'green',
		"$C_terminalColor03$", -- 'olive',
		"$C_terminalColor04$", -- 'navy',
		"$C_terminalColor05$", -- 'purple',
		"$C_terminalColor06$", -- 'teal',
		"$C_terminalColor07$", -- 'silver',
	},
	brights = {
		"$C_terminalColor08$", -- 'grey',
		"$C_terminalColor09$", -- 'red',
		"$C_terminalColor0A$", -- 'lime',
		"$C_terminalColor0B$", -- 'yellow',
		"$C_terminalColor0C$", -- 'blue',
		"$C_terminalColor0D$", -- 'fuchsia',
		"$C_terminalColor0E$", -- 'aqua',
		"$C_terminalColor0F$", -- 'white',
	},
