let
  b = builtins;
  placeholderTypes = { C = "color"; K = "key"; };
...
in rec {
  ...
  readAndInterpolate =  globalSet: filePath:
  let 
    fileString = b.readFile filePath;
    placeholders = findAllPlaceholders fileString; in
      b.replaceStrings
        placeholders
